#######################################################################
# Rasterising weather station data PRECIPITATION - EUROPE
# Fred Shone
# 26th March 2018
...
regpoints <- fread("bboxEuroGrid_5_km.csv",header=T) #Load regular point grid
#Convert to SP
...
dataSelected$PRCP_AMT[dataSelected$PRCP_AMT >= 1] <- 1
print(paste(nrow(dataSelected), "rows remaining after trim" ))
